...
Pod::Spec.new do |s|
  s.name             = "MediaPlayer-VolumeControl"
  s.version          = "1.0.0"
  ...
  s.source           = { :git => "https://github.com/vilyever/MediaPlayer-VolumeControl.git", :tag => s.version.to_s }
  ...
  s.resource_bundles = {
    'MediaPlayer-VolumeControl' => ['Pod/Assets/*.png']
  }
